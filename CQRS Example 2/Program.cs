    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            try
            {
                ...
                var multiplyQuery = new MultiplierQuery(ledger);
                do
                {
                    ...
                    switch (Enum.Parse<Options>(command))
                    {
                        ...
                        case Options.SumQuery:
                            ...
                            break;
                        case Options.DisplayMultiQuery:
                            Console.WriteLine(multiplyQuery.Display());
                            break;
                        case Options.MultiplyQuery:
                            Console.WriteLine(multiplyQuery.Multiply());
                            break;
                    }
